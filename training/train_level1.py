"""
Level 1: Walking Training Script
Train Go2 to walk at 0.5-1.0 m/s
"""
...
def train():
    ...
    log_dir = os.path.join('logs', 'level1_walk', timestamp)
    model_dir = os.path.join('models', 'level1_walk', timestamp)
    ...
    print("=" * 60)
    print("Level 1: Walking Training")
    print("=" * 60)
    print(f"Target: {config.target_vel_min}-{config.target_vel_max} m/s")
